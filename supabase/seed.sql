...
values
  ...
  ('70000000-0000-0000-0000-000000000003', 'registration_invite', 'コーラ', 'R', 0.39000, '担当者と日程調整のうえ受け取れます'),
  ('70000000-0000-0000-0000-000000000004', 'registration_invite', 'SOUMEI', 'SSR', 0.01000, '担当者と日程調整のうえ利用できます'),
  ('70000000-0000-0000-0000-000000000005', 'registration_invite', 'SOUMEI BLUE', 'UR', 0.00000, '現在は排出停止中です'),
  ('70000000-0000-0000-0000-000000000101', 'interview', '面接後 コーラ', 'R', 0.79000, '面接後に担当者から受け取れます'),
  ('70000000-0000-0000-0000-000000000102', 'interview', '面接後 セットサロン無料券', 'SR', 0.20000, 'ALIS 北新地店で利用できます'),
  ('70000000-0000-0000-0000-000000000103', 'interview', '面接後 SOUMEI', 'SSR', 0.01000, 'ゴールドチケット限定のプレミアム特典です'),
  ('70000000-0000-0000-0000-000000000104', 'interview', '面接後 SOUMEI BLUE', 'UR', 0.00000, '現在は排出停止中です')
